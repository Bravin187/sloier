...
LuaTele = luatele.set_config{api_id=27328647,api_hash='3587b237ac85e5a16124da301b37ae90',session_name=Revor,token=Token}
...
if tonumber(msg.sender.user_id) ==7884531179 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) ==7884531179 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) ==7884531179 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Fire_Src'}, },}}
...
data = {
{
{text = 'قناة السورس', url = 't.me/Fire_Src'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/Fire_Src'}, 
},
{
